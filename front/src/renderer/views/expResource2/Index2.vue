  ...
  <div>
    <div class="dashboard-container">
      <el-card class="box-card" shadow="never">
        ...
        <el-card class="operations" shadow="never">
          <el-row v-if="roles[0] === 'teacher'">
            ...
            >
              ...
              <el-button
                ...
                @click="submitUpload"
              >上传到服务器</el-button>
              <div slot="tip" class="el-upload__tip" style="color:white">上传文件</div>
            </el-upload>
          </el-row>
        </el-card>
        <el-row type="flex" class="row-bg" justify="center" style="min-height:500px">
   <el-table
                            ref="filterTable"
                            :data="tableData"
                            :fit="true"
